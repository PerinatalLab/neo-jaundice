...
m1$cond= factor(m1$cond, levels= c('Not adjusted', 'ABO_incompatibility'))
...
p1= ggplot(m1, aes(x = term, y = estimate, colour= cond)) + 
  ...
  scale_color_manual(values= colorBlindBlack8[c(2, 6)], guide= 'none') +
