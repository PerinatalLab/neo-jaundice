...
print(nrow(pheno))
write( paste('snp', 'n', 'beta_h1', 'se_h1', 'pvalue_h1', 'beta_h2', 'se_h2', 'pvalue_h2', 'beta_h3', 'se_h3', 'pvalue_h3', 'beta_h4', 'se_h4', 'pvalue_h4', 'pval_poe', sep= '\t'), snakemake@output[[1]], append= T)
...
pval_poe= tryCatch(linearHypothesis(m1, 'h1 - h2 = h3 - h4')[['Pr(>F)']][2], warning= function(w){NA}, error= function(w) {NA})


results= paste(snp, n, beta_h1, se_h1, pvalue_h1, beta_h2, se_h2, pvalue_h2, beta_h3, se_h3, pvalue_h3, beta_h4, se_h4, pvalue_h4, pval_poe, sep= '\t')
